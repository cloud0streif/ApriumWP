  ...
  return (
    <section ref={sectionRef} className="py-10 lg:py-16" style={{ backgroundColor: "rgba(255, 255, 255, 0.75)" }}>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        {/* Mobile: always-expanded static cards */}
        <div className="flex flex-col gap-4 py-6 sm:hidden">
          {capabilities.map((cap, i) => (
            ...
            >
              <div
                className="rounded-xl border-l-4 border-l-aprium-orange px-6 py-5 pb-6"
                style={{
                  ...
                  borderRadius: "12px",
                  boxShadow: "0 4px 24px rgba(61, 17, 82, 0.08)",
                }}
              >
